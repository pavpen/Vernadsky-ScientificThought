...
Calcutta.\footnoteRus{Института Бозе в Калькутте}\footnoteEd{
	...
	selection, microbiology, etc. \parenNoteAuth{Ed.}
...
[phenomena],\footnoteTransl{%
	inserted by transl. \parenNoteAuth{Pav}
} we would inevitably go beyond the limits of the phenomena of life studied in
...
Man, like every living natural (or naturally-occurring)\footnoteRus{%
	природное (или естественное)
} body, is inseparably connected with a certain geological envelope of our
...
organization},\footnoteTransl{%
	организованностью, \ie\ organizedness, or being (constantly) organized.
	\parenNoteAuth{Pav}
} and occupying a lawfully expressible place in it as a distinct part of the
whole.
...
becoming,\footnoteTransl{%
	становлении, \eg\ formation. \parenNoteAuth{Pav}
} of motion of all of its smallest material and energetic particles.  We can
...
(material or energetic) lawfully returns to, \altStylePhr{or}\footnoteEd{
...
so-called \emph{persistents}\footnoteRus{
	...
	today. \parenNoteAuth{Pav}
}\fncomma\footnoteEd{
	persistents\dots\ See \cite[269]{vernadsky1965himicheskoe}.
	\parenNoteAuth{Ed.}
...
rivers]\footnoteTransl{
	Interpolated from the implied meaning. \parenNoteAuth{Pav}
} of the Tertiery, and of our period.  This is an area of new phenomena, hardly
...
observed.\footnoteEd{
	...
	in which V.~I.\ Vernadsky used this word.  \parenNoteAuth{Ed.}
...
organisms, or [in] the Paleocene, when the fauna of mammals grew.\footnoteEd{
	...
	determined to a large degree. \parenNoteAuth{Ed.}
...
dissonance.\footnoteEd{
	...
	(\cite{yanshin1988evolyuciya}).  \parenNoteAuth{Ed.}
}
