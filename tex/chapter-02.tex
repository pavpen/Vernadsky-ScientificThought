...
First, the universality\footnoteRus{
	вселенскости, \ie{} `ecumenicism' (see \autoref{ch:3}).
} of mankind observable today---on the one hand, the complete encompassing of
the biosphere for human life by mankind, and, on the other, the lack of the
isolation\footnoteTransl{historical isolation} of individual populations thanks
...
Third, the problem of the conscious regulation of reproduction, of the
...
international\footnoteRus{интернационал ученых} played a major role, and had
deep roots in the Medieval unity of the real, but amorphous centuries-old
philosophical and scientific international\footnoteRus{интернационала философов
и ученых}.
...
All mentioned so far indicates that the real circumstance in our tumultuous and
...
Scientifically, the phenomena of life are observed in only the last two layers
...
Science is a creation of life.  Scientific thought draws the material that it
...
obligatory and incontrovertible for all their constructs.\footnote{
	...
	\refparencite{vernadsky1902nauchnom}, I attempted to clarify the
...
We find ourselves only at the beginning of the process, and cannot grasp the
