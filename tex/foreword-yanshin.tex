...
book \btcite{vernadsky1926biosfera}, which was first published in 1926, and has
...
However, V.~I.\ Vernadsky got to arrive at the unavoidable conclusion about the
...
biosphere's evolution in the last decade of his life.  Such a course of thougts
brought him to the conclusion that the emergence of man, and the impact of his
activity on the surrounding natural environment is not an accident, is not an
`imposed' process on the natural course of events, but is, rather, a definite,
lawful stage of the evolution of the biosphere.  This stage has to lead to the
condition that the Earth's biosphere must transition into a new state, which he
proposed to call `noosphere' (from the Greek word
...
their arrests, he wrote letters to J.~V.\ Stalin, N.~I.\ Ezhov, L.~P.\ Beria.
His diaries from these years are filled with heavy words.  But the book,
written by him for the future generations, was permeated by optimism, faith in
...
in a truly universal\footnoteRus{вселенской, \ie, also, `ecumenical' (see
\autoref{ch:3}).} vastness.

\rtitle{Scientific Thought as Planetary Phenomenon}---this is an apex of V.~I.\ 
